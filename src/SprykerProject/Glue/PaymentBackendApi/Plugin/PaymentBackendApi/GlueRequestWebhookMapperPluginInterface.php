...
namespace AppPayment\Glue\PaymentBackendApi\Plugin\PaymentBackendApi;
 ...
 * 2. The `\AppPayment\Glue\PaymentBackendApi\Plugin\PaymentBackendApi\GlueRequestWebhookMapperPluginInterface` is used when the transaction id is available e.g. in request headers or in the URL.
 *
