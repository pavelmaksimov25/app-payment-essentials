<?php  //[STAMP] 94942841e05facf228366079051bbaeb
// phpcs:ignoreFile
namespace SprykerProjectTest\Glue\PaymentBackendApi\_generated;

// This class was automatically generated by build task
// You should not change it manually as it will be overwritten on next build

trait PaymentBackendApiTesterActions
{
    /**
     ...
     *
     *
     * @see \SprykerProjectTest\Zed\Payment\Helper\PaymentHelper::getPaymentBusinessFactory()
     */
    public function getPaymentBusinessFactory(): \SprykerProject\Zed\Payment\Business\PaymentBusinessFactory {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPaymentBusinessFactory', func_get_args()));
    }
     ...
     * @see \SprykerProjectTest\Zed\Payment\Helper\PaymentHelper::getPaymentPageRequest()
     */
    public function getPaymentPageRequest(?string $transactionId = NULL, ?string $tenantIdentifier = NULL): \Symfony\Component\HttpFoundation\Request {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getPaymentPageRequest', func_get_args()));
    }
