<?php  //[STAMP] fa64dbcffd5a746ab7b310b29a9cfa0b
// phpcs:ignoreFile
namespace SprykerProjectTest\AsyncApi\Payment\_generated;

// This class was automatically generated by build task
// You should not change it manually as it will be overwritten on next build

trait PaymentAsyncApiTesterActions
{
    /**
     ...
     * @see \SprykerTest\Service\Container\Helper\ContainerHelper::getContainer()
     */
    public function getContainer(): \Spryker\Service\Container\ContainerInterface {
     ...
     *
     * @return void
     * @see \Spryker\Zed\TestifyAsyncApi\Business\Codeception\Helper\AsyncApiHelper::setAsyncApi()
     */
    public function setAsyncApi(string $asyncApiSchemaFilePath): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('setAsyncApi', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \Spryker\Zed\TestifyAsyncApi\Business\Codeception\Helper\AsyncApiHelper::assertMessageWasEmittedOnChannel()
     */
    public function assertMessageWasEmittedOnChannel(\Spryker\Shared\Kernel\Transfer\AbstractTransfer $messageTransfer, string $channelNameToTest, ?callable $assertion = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertMessageWasEmittedOnChannel', func_get_args()));
    }
     ...
     *
     * @return void
     * @see \Spryker\Zed\TestifyAsyncApi\Business\Codeception\Helper\AsyncApiHelper::runMessageReceiveTest()
     */
    public function runMessageReceiveTest(\Spryker\Shared\Kernel\Transfer\AbstractTransfer $messageTransfer, string $channelNameToTest, ?callable $handler = NULL): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('runMessageReceiveTest', func_get_args()));
    }
     ...
     *
     *
     * @see \SprykerProjectTest\Shared\Payment\Helper\PaymentAssertionHelper::assertPaymentHasStatus()
     */
    public function assertPaymentHasStatus(\Generated\Shared\Transfer\PaymentTransfer $paymentTransfer, string $expectedStatus): void {
        $this->getScenario()->runStep(new \Codeception\Step\Action('assertPaymentHasStatus', func_get_args()));
    }
}
